<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="orderNumber" label="排序号"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    editHandle(id) {
      this.$axios.get("/sys/menu/info" + id).then((response) => {
    ...
    delHandle(){
      this.$axios.post("sys/menu/delete/"+id).then(response=>{
        this.$message({
                message: "删除成功",
                type: "success",
                onClose: () => {
